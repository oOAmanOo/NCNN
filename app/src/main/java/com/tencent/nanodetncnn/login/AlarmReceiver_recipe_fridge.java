...
public class AlarmReceiver_recipe_fridge extends BroadcastReceiver {
    ...
    private static String NOTIFICATION_id = "3";
    private static String NOTIFICATION_NAME="notify_recipe_fridge";
    private final static String NOTIFICATION_description="notify_recipe_fridge";
    ...
    private static final Runnable upload = new Runnable() {
        public void run() {
            ...
            try {
                ...
                List<NameValuePair> params = new ArrayList<NameValuePair>();
                params.add(new BasicNameValuePair("title", "清冰箱食譜推薦"));
