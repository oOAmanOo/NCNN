...
public class fridge_editfridge_ListAdapter_21 extends RecyclerView.Adapter<fridge_editfridge_ListAdapter_21.fridge_editfridge_ListHolder_21> {
    ...
    public fridge_editfridge_ListAdapter_21(Context context, String[] editfridge_did, String[] editfridge_name, String[] editfridge_imgName){
    ...
    @Override
    public fridge_editfridge_ListHolder_21 onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(MainActivity.mContext2).inflate(R.layout.editfridge_adapter21,parent,false);
        fridge_editfridge_ListHolder_21 holder = new fridge_editfridge_ListHolder_21(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull fridge_editfridge_ListHolder_21 holder, @SuppressLint("RecyclerView") int position) {
...
//        holder.d2_imageView.setImageResource(R.drawable.pic1);
    ...
    static class fridge_editfridge_ListHolder_21 extends RecyclerView.ViewHolder {
