...
public class fridge_editfridge_ListAdapter_22 extends RecyclerView.Adapter<fridge_editfridge_ListAdapter_22.fridge_editfridge_ListHolder_22> {
    ...
    @Override
    public fridge_editfridge_ListHolder_22 onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(MainActivity.mContext2).inflate(R.layout.editfridge_adapter22,parent,false);
        fridge_editfridge_ListHolder_22 holder = new fridge_editfridge_ListHolder_22(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull fridge_editfridge_ListHolder_22 holder, @SuppressLint("RecyclerView") int position) {
...
//                                    MainActivity.editfridge_fault[editfridge_index21] = -1;
    ...
    static class fridge_editfridge_ListHolder_22 extends RecyclerView.ViewHolder {
