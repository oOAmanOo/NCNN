...
public class editfridge_ListAdapter_2 extends RecyclerView.Adapter<editfridge_ListAdapter_2.editfridge_ListHolder_2> {
    ...
    public editfridge_ListAdapter_2(Context context, String[] editfridge_did, String[] editfridge_name, String[] editfridge_imgName){
    ...
    @Override
    public editfridge_ListHolder_2 onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.editfridge_adapter21,parent,false);
        editfridge_ListHolder_2 holder = new editfridge_ListHolder_2(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull editfridge_ListHolder_2 holder, @SuppressLint("RecyclerView") int position) {
...
//        holder.d2_imageView.setImageResource(R.drawable.pic1);
        ...
        int[] editfridgedb_memo = new int[MainActivity.editfridge_count[position]];
        int[] editfridgedb_editnum = new int[MainActivity.editfridge_count[position]];
        int count_index = 0;
        for (int i = 0; i < position - 1; i++) {
            count_index += MainActivity.editfridge_count[i];
        }
        for (int i = count_index; i < count_index + MainActivity.editfridge_count[position]; i++) {
            editfridgedb_fid[i] = MainActivity.editfridgedb_fid[i];
            editfridgedb_did[i] = MainActivity.editfridgedb_did[i];
            editfridgedb_position[i] = MainActivity.editfridgedb_position[i];
            editfridgedb_insertDate[i] = MainActivity.editfridgedb_insertDate[i];
            editfridgedb_expireDate[i] = MainActivity.editfridgedb_expireDate[i];
            editfridgedb_uid[i] = MainActivity.editfridgedb_uid[i];
            editfridgedb_amount[i] = MainActivity.editfridgedb_amount[i];
            editfridgedb_memo[i] = MainActivity.editfridgedb_memo[i];
            editfridgedb_editnum[i] = MainActivity.editfridgedb_editnum[i];
        }
        editfridge_ListAdapter_3 editfridge_listAdapter_3 = new editfridge_ListAdapter_3(editfridge_dfragment2.nested_f,editfridgedb_fid, editfridgedb_did, editfridgedb_position, editfridgedb_insertDate, editfridgedb_expireDate, editfridgedb_uid, editfridgedb_amount, editfridgedb_memo, editfridgedb_editnum);
        holder.ef21_recyclerview.setLayoutManager(new LinearLayoutManager(holder.ef21_recyclerview.getContext()));
        holder.ef21_recyclerview.setAdapter(editfridge_listAdapter_3);
    }
    ...
    static class editfridge_ListHolder_2 extends RecyclerView.ViewHolder {
