...
public final class ListAdapter1Binding implements ViewBinding {
  @NonNull
  ...
  private ListAdapter1Binding(@NonNull FrameLayout rootView, @NonNull CardView d1Card,
  ...
  @NonNull
  public static ListAdapter1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListAdapter1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_adapter1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListAdapter1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListAdapter1Binding((FrameLayout) rootView, d1Card, d1ImageView, d1TextView);
    }
